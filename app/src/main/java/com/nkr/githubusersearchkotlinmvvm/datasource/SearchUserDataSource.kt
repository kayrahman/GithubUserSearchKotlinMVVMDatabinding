...
class SearchUserDataSource(
   ...
   // val searchRepo = SearchRepo()
    ...
    override fun loadInitial(
        ...
        repo.getUserSearchList(userQuery,FIRST_PAGE,object : BaseRepo.RequestStatusCallBack{
            ...
            override fun <T> resultSuccess(results: T) {
                ...
                var response = results as GithubSearchResponse
    ...
    override fun loadAfter(
        ...
        repo.getUserSearchList(userQuery,params.key,object : BaseRepo.RequestStatusCallBack{
            override fun startRequest() {
